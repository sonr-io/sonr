...
<Accordion>
  <AccordionItem title="Vault Client (internal/vault/vault.go)" icon="code">
...
<AccordionItem title="WASM Plugin (cmd/vault/main.go)" icon="cube">
...
>
  ...
  **Security Features:** - Vault state persistence with enclave data separation
  ...
  <AccordionItem title="MPC Enclave (crypto/mpc/enclave.go)" icon="lock">
...
<Accordion>
  <AccordionItem title="Vault Generation and Key Derivation" defaultOpen>
...
<AccordionItem title="Transaction Signing (Cosmos, EVM)">
...
<AccordionItem title="Message Signing and Verification">
...
<AccordionItem title="Key Rotation and Vault Management">
  ...
  <AccordionItem title="IPFS Storage and Retrieval">
...
<Accordion>
  <AccordionItem title="CRITICAL-001: Weak Authentication System" icon="shield-x">
...
>
  ...
  <AccordionItem title="CRITICAL-003: Hardcoded Default Passwords" icon="shield-x">
...
<Accordion>
  <AccordionItem title="HIGH-001: No Encrypted Data Integrity Verification" icon="alert-triangle">
...
>
  ...
  <AccordionItem title="HIGH-004: Race Conditions in Concurrent Vault Access" icon="alert-triangle">
...
<Accordion>
  <AccordionItem title="MEDIUM-001: Weak Key Derivation for Encryption">
    - **Location:** `crypto/mpc/enclave.go:78`
    - **CVSS Score:** 5.9 (AV:N/AC:H/PR:N/UI:N/S:U/C:H/I:N/A:N)
  </AccordionItem>

<AccordionItem title="MEDIUM-002: Missing Request Replay Protection">
  - **Location:** Various signing functions - **CVSS Score:** 5.4
  (AV:N/AC:L/PR:L/UI:R/S:C/C:L/I:L/A:N)
</AccordionItem>

<AccordionItem title="MEDIUM-003: Insufficient Error Context in Logs">
  - **Location:** Throughout codebase - **CVSS Score:** 4.3
  (AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:L)
</AccordionItem>

<AccordionItem title="MEDIUM-004: No Key Rotation Enforcement">
  - **Location:** `cmd/vault/main.go:986-988` - **CVSS Score:** 4.2
  (AV:N/AC:L/PR:H/UI:N/S:U/C:L/I:L/A:N)
</AccordionItem>

<AccordionItem title="MEDIUM-005: WebAuthn Implementation Placeholder">
  - **Location:** `cmd/vault/main.go:947-954` - **CVSS Score:** 5.8
  (AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N)
</AccordionItem>

  <AccordionItem title="MEDIUM-006: Insufficient Resource Cleanup">
...
<AccordionItem title="Low Risk Issues Summary">
...
<Accordion>
  <AccordionItem title="Phase 1: Critical Security Fixes (2-3 weeks)" defaultOpen>
...
<AccordionItem title="Phase 2: High-Risk Remediation (4-6 weeks)">
  - Data integrity verification - Signature security improvements - Input
  validation enhancements - Concurrent access protection
</AccordionItem>

<AccordionItem title="Phase 3: Production Hardening (8-12 weeks)">
  ...
  <AccordionItem title="Phase 4: Enterprise Readiness (6-8 months)">
