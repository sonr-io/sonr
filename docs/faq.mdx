...
<Accordion>
    <AccordionItem title="What Components make up the Sonr stack?">
        ...
        **Blockchain** -- The Blockchain is the perfect marriage for Sonr's global decentralized network. With Cosmos, we can quickly and easily connect to other blockchains, providing our users with the ability to build interoperable experiences. IBC is the perfect specification for cross-chain communication, and GravityBridge provides us with the perfect way to bridge to Ethereum. Sonr’s blockchain also provides developer with the peace of mind of knowing that user data is securely distributed across IPFS with a native bridge to Filecoin.
        ...
        <AccordionItem title="What’s preventing Web3 Mobile Apps from going mainstream?">
        ...
        <AccordionItem title="Will DIDs replace traditional authentication in the future?">
        ...
        <AccordionItem title="How large is the Cosmos Ecosystem?">
        ...
        <AccordionItem title="What was Tim Berners Lee’s Original Vision for the Internet?">
...
<Accordion>
    <AccordionItem title="Why build on Sonr?">
    ...
    <AccordionItem title="Does Sonr have Wallet to Wallet Messaging?">
